                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <select name="pembayaran_beras" class="form-control">
                            ...
                            <option value="2.7" <?php if( $dt['pembayaran_beras']=='2.7'){echo "selected"; } ?>>3,5 kg</option>
                            <option value="2.7" <?php if( $dt['pembayaran_beras']=='2.7'){echo "selected"; } ?>>3,7 kg</option>
                          </select>
                      </div>
                  </div>
              </div>
