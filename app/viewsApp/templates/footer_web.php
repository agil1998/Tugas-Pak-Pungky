<!-- footer_start  -->
                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="<?= BASEURL; ?>/kebayoran.png" style="width: 240px" alt="">
                                </a>
                            </div>
                            <p class="address_text">Badan Zakat Fitra Masjid Raya Kebayoran Residence
                            </p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>+62 87812632330</li>
                                <li><a href="#">DPM.kebayoran@gmail.com</a></li>
                                <li>Bintaro Jaya Sektor 7, Jalan Kebayoran Residences, Pondok Aren, South Tangerang City</li>
                            </ul>
                        </div>
                    </div>
  ...
  Copyright &copy;2020 <a href="https://github.com/agil1998"><b>agil1998.</b></a> All rights reserved <!-- | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> -->
